        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <form onSubmit={handleSubmit} className="animate-on-scroll lg:col-span-3 space-y-6" data-testid="contact-form">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-3 bg-[#10b981] text-white px-10 py-4 text-sm font-bold uppercase tracking-widest hover:bg-[#059669] transition-all hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto"
